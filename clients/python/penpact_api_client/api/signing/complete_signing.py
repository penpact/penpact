...
from ...models.complete_signing_body import CompleteSigningBody
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/sign/{signing_token}/complete".format(signing_token=signing_token,),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Submit completed fields and sign
