...
T = TypeVar("T", bound="SigningSessionBranding")



@_attrs_define
class SigningSessionBranding:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        signing_session_branding.additional_properties = d
        return signing_session_branding
