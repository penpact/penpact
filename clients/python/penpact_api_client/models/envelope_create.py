...
T = TypeVar("T", bound="EnvelopeCreate")
...
class EnvelopeCreate:
    """ 
        Attributes:
            ...
            reminder_every_hours (Union[Unset, int]): Re-nudge unsigned signers every N hours.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        envelope_create.additional_properties = d
        return envelope_create
